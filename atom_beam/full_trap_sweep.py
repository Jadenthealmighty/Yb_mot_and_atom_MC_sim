...
NOZZLE_ATOMS = _envi("FT_NOZZLE_ATOMS", 300_000_000)
...
SLOWER_W_OPTIC_M = _envf("FT_SLOWER_W_OPTIC_M", 0.00875)
SLOWER_DIVERGENCE_MRAD = _envf("FT_SLOWER_DIV_MRAD", 0.0)
SLOWER_FOCUS_MM = _envf("FT_SLOWER_FOCUS_MM", 0.0)
SLOWER_AVG_SAT = _envf("FT_SLOWER_AVG_SAT", 0.163) # TRY 1.0 next
SLOWER_DETUNING_HZ = _envf("FT_SLOWER_DETUNING_HZ", -82578000)
